...
lean_ctor_set(v___x_785_, 1, v___y_765_);
...
lean_ctor_set(v___x_786_, 2, v___y_762_);
...
v___x_1127_ = l_Lean_setEnv___at___00Lean_Elab_wfRecursion_spec__9___redArg(v___y_1122_, v___y_1124_, v___y_1121_);
