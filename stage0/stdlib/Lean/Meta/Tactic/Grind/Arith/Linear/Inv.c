...
lean_dec_ref_known(v_fst_1263_, 1);
if (v_isShared_1262_ == 0)
{
...
lean_dec_ref_known(v_fst_1908_, 1);
if (v_isShared_1907_ == 0)
{
...
lean_dec_ref_known(v_fst_2168_, 1);
if (v_isShared_2167_ == 0)
{
...
lean_dec_ref_known(v_x_2992_, 2);
