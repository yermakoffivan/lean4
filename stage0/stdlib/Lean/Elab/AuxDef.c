...
LEAN_EXPORT lean_object* l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_Elab_Command_elabAuxDef_spec__4(lean_object* v_as_143_, size_t v_i_144_, size_t v_stop_145_, lean_object* v_b_146_){
_start:
{
uint8_t v___x_147_; 
...
lean_inc(v___x_148_);
v___x_149_ = l_Lean_Name_append(v_b_146_, v___x_148_);
...
LEAN_EXPORT lean_object* l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_Elab_Command_elabAuxDef_spec__4___boxed(lean_object* v_as_153_, lean_object* v_i_154_, lean_object* v_stop_155_, lean_object* v_b_156_){
_start:
{
...
v_res_159_ = l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_Elab_Command_elabAuxDef_spec__4(v_as_153_, v_i_boxed_157_, v_stop_boxed_158_, v_b_156_);
lean_dec_ref(v_as_153_);
return v_res_159_;
}
}
LEAN_EXPORT lean_object* l_List_mapTR_loop___at___00Lean_Elab_Command_elabAuxDef_spec__2(lean_object* v_a_160_, lean_object* v_a_161_){
_start:
{
...
v___x_168_ = 0;
v___x_169_ = l_Lean_Name_toString(v_head_163_, v___x_168_);
...
lean_ctor_set(v_reuseFailAlloc_173_, 1, v_a_161_);
...
LEAN_EXPORT lean_object* l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Elab_Command_elabAuxDef_spec__3(size_t v_sz_175_, size_t v_i_176_, lean_object* v_bs_177_){
_start:
{
uint8_t v___x_178_; 
...
{
lean_object* v_v_179_; lean_object* v___x_180_; lean_object* v_bs_x27_181_; lean_object* v___x_182_; lean_object* v___x_183_; size_t v___x_184_; size_t v___x_185_; lean_object* v___x_186_; 
v_v_179_ = lean_array_uget(v_bs_177_, v_i_176_);
v___x_180_ = lean_unsigned_to_nat(0u);
v_bs_x27_181_ = lean_array_uset(v_bs_177_, v_i_176_, v___x_180_);
v___x_182_ = l_Lean_TSyntax_getId(v_v_179_);
lean_dec(v_v_179_);
v___x_183_ = lean_erase_macro_scopes(v___x_182_);
v___x_184_ = ((size_t)1ULL);
v___x_185_ = lean_usize_add(v_i_176_, v___x_184_);
v___x_186_ = lean_array_uset(v_bs_x27_181_, v_i_176_, v___x_183_);
v_i_176_ = v___x_185_;
v_bs_177_ = v___x_186_;
goto _start;
}
}
}
LEAN_EXPORT lean_object* l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Elab_Command_elabAuxDef_spec__3___boxed(lean_object* v_sz_188_, lean_object* v_i_189_, lean_object* v_bs_190_){
_start:
{
...
lean_dec(v_i_189_);
v_res_193_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Elab_Command_elabAuxDef_spec__3(v_sz_boxed_191_, v_i_boxed_192_, v_bs_190_);
return v_res_193_;
}
}
...
v_val_329_ = lean_ctor_get(v___y_314_, 0);
lean_inc(v_val_329_);
...
lean_inc(v___y_336_);
v___x_363_ = l_Lean_Name_str___override(v___y_336_, v___x_360_);
...
v___x_370_ = l_Lean_Name_replacePrefix(v_fst_365_, v_currNamespace_349_, v___y_336_);
lean_dec(v___y_336_);
...
v___x_248_ = l_Lean_Syntax_node1(v___y_236_, v___y_242_, v___y_244_);
...
v___x_254_ = l_Lean_Syntax_node1(v___y_236_, v___y_242_, v___x_253_);
lean_inc_ref_n(v___x_249_, 8);
v___x_255_ = l_Lean_Syntax_node7(v___y_236_, v___y_232_, v___y_233_, v___x_247_, v___x_248_, v___x_249_, v___x_254_, v___x_249_, v___x_249_);
...
v___x_273_ = l_Lean_Syntax_node2(v___y_236_, v___x_270_, v___x_272_, v___y_240_);
v___x_274_ = l_Lean_Syntax_node1(v___y_236_, v___y_242_, v___x_273_);
...
v___x_286_ = l_Lean_Syntax_node2(v___y_236_, v___y_243_, v___x_255_, v___x_285_);
v___x_287_ = l_Lean_Elab_Command_elabCommand(v___x_286_, v___y_234_, v___y_238_);
return v___x_287_;
}
}
}
