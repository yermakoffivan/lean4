...
v___x_293_ = lean_mk_string_unchecked("runtime", 7, 7);
return v___x_293_;
}
}
...
v___x_294_ = lean_mk_string_unchecked("maxRecDepth", 11, 11);
return v___x_294_;
}
}
