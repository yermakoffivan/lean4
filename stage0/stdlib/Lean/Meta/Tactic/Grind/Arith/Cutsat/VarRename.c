...
static lean_once_cell_t l_Int_Linear_Expr_renameVars___closed__0_once = LEAN_ONCE_CELL_INITIALIZER;
...
static lean_object* _init_l_Int_Linear_Expr_renameVars___closed__0(void){
_start:
{
...
v___x_80_ = lean_obj_once(&l_Int_Linear_Expr_renameVars___closed__0, &l_Int_Linear_Expr_renameVars___closed__0_once, _init_l_Int_Linear_Expr_renameVars___closed__0);
return v___x_80_;
}
else
{
