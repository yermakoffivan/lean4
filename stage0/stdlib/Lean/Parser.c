...
lean_ctor_set_uint8(v___x_772_, sizeof(void*)*2, v___y_764_);
...
v___x_940_ = l_Lean_Parser_registerAlias(v___x_937_, v___x_938_, v___x_939_, v___y_933_, v___y_935_);
