...
lean_ctor_set(v___x_1394_, 10, v___y_1383_);
if (v_isShared_1380_ == 0)
{
lean_ctor_set(v___x_1379_, 1, v___y_1389_);
...
lean_ctor_set(v_reuseFailAlloc_1397_, 1, v___y_1389_);
...
v___x_1402_ = lean_array_get_size(v___y_1389_);
v___x_1403_ = lean_array_push(v___y_1389_, v___x_1401_);
if (v_isShared_1380_ == 0)
{
