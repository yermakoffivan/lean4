...
v___x_992_ = l_Lean_Compiler_LCNF_getPhase___redArg(v___y_989_);
...
lean_dec(v_a_993_);
lean_inc(v_declName_897_);
v___x_995_ = l_Lean_Compiler_LCNF_getDeclAt_x3f(v_declName_897_, v___x_994_, v___y_985_, v___y_987_);
