...
lean_ctor_set(v___x_258_, 0, v___y_238_);
lean_ctor_set(v___x_258_, 1, v___y_234_);
lean_ctor_set(v___x_258_, 2, v___y_236_);
lean_ctor_set(v___x_258_, 3, v___y_232_);
lean_ctor_set(v___x_258_, 4, v___x_257_);
lean_ctor_set_uint8(v___x_258_, sizeof(void*)*5, v___y_237_);
...
v___x_282_ = l_Lean_FileMap_toPosition(v___y_274_, v___y_271_);
lean_dec(v___y_271_);
...
v___x_301_ = l_Lean_Syntax_getTailPos_x3f(v___y_298_, v___y_296_);
lean_dec(v___y_298_);
