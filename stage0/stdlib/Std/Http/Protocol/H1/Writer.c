...
v___x_727_ = lean_mk_string_unchecked("=", 1, 1);
return v___x_727_;
}
}
...
v___x_756_ = lean_mk_string_unchecked("\r\n", 2, 2);
return v___x_756_;
}
}
...
v___x_759_ = lean_mk_string_unchecked("", 0, 0);
return v___x_759_;
}
}
