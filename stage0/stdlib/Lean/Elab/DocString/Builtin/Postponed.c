...
lean_ctor_set(v___x_1715_, 2, v___y_1695_);
lean_ctor_set(v___x_1715_, 3, v___y_1690_);
lean_ctor_set(v___x_1715_, 4, v___x_1714_);
lean_ctor_set_uint8(v___x_1715_, sizeof(void*)*5, v___y_1692_);
lean_ctor_set_uint8(v___x_1715_, sizeof(void*)*5 + 1, v___y_1694_);
...
v___x_1739_ = l_Lean_FileMap_toPosition(v___y_1730_, v___y_1726_);
