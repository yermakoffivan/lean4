...
v___x_689_ = l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_Parser_Error_toString_spec__1___redArg(v___y_684_, v___y_687_, v___y_685_, v___y_688_);
lean_dec(v___y_688_);
lean_dec(v___y_684_);
...
{
uint8_t v___x_697_; 
v___x_697_ = lean_nat_dec_le(v___y_696_, v___y_692_);
if (v___x_697_ == 0)
{
lean_dec(v___y_692_);
lean_inc(v___y_696_);
