...
@[simp, backward_defeq] theorem toInt_int (x : Int) : ToInt.toInt x = x := rfl
...
@[simp, defeq] theorem toInt_nat (x : Nat) : ToInt.toInt x = (x : Int) := rfl
...
@[simp, grind =, defeq] theorem toInt_fin (x : Fin n) : ToInt.toInt x = (x.val : Int) := rfl
...
@[simp, defeq] theorem toInt_uint8 (x : UInt8) : ToInt.toInt x = (x.toNat : Int) := rfl
...
@[simp, defeq] theorem toInt_uint16 (x : UInt16) : ToInt.toInt x = (x.toNat : Int) := rfl
...
@[simp, defeq] theorem toInt_uint32 (x : UInt32) : ToInt.toInt x = (x.toNat : Int) := rfl
...
@[simp, defeq] theorem toInt_uint64 (x : UInt64) : ToInt.toInt x = (x.toNat : Int) := rfl
...
@[simp, defeq] theorem toInt_usize (x : USize) : ToInt.toInt x = (x.toNat : Int) := rfl
...
@[simp, defeq] theorem toInt_int8 (x : Int8) : ToInt.toInt x = (x.toInt : Int) := rfl
...
@[simp, defeq] theorem toInt_int16 (x : Int16) : ToInt.toInt x = (x.toInt : Int) := rfl
...
@[simp, defeq] theorem toInt_int32 (x : Int32) : ToInt.toInt x = (x.toInt : Int) := rfl
...
@[simp, defeq] theorem toInt_int64 (x : Int64) : ToInt.toInt x = (x.toInt : Int) := rfl
...
@[simp, defeq] theorem toInt_bitVec (x : BitVec v) : ToInt.toInt x = (x.toNat : Int) := rfl
...
@[simp, defeq] theorem toInt_isize (x : ISize) : ToInt.toInt x = x.toInt := rfl
