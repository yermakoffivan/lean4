...
lean_ctor_set(v___x_844_, 1, v___y_823_);
...
lean_ctor_set(v___x_845_, 3, v___y_822_);
...
v___x_869_ = l_Lean_FileMap_toPosition(v___y_859_, v___y_857_);
lean_dec(v___y_857_);
...
v___y_893_ = v___y_904_;
v___y_894_ = v___y_906_;
v___y_895_ = v___y_905_;
...
lean_inc(v_n_2414_);
lean_dec_ref_known(v_t_2412_, 1);
...
lean_dec_ref_known(v___x_3264_, 5);
...
{
lean_dec_ref_known(v_val_3868_, 2);
