...
v___x_3156_ = l_Lean_Name_toStringWithToken___at___00Lean_Name_toString_spec__0(v___y_3148_, v___y_3147_);
v___x_3157_ = lean_string_append(v___x_3155_, v___x_3156_);
lean_dec_ref(v___x_3156_);
v___x_3158_ = lean_string_append(v___x_3157_, v___y_3150_);
...
v___x_5438_ = l___private_Lake_Load_Resolve_0__Lake_Workspace_resolveDepsCore_go___at___00Lake_Workspace_materializeDeps_spec__0___redArg(v___y_5432_, v___y_5435_, v_leanOpts_5426_, v_reconfigure_5427_, v_ws_5424_, v___y_5433_, v___x_5437_, v___y_5434_);
...
v___x_5471_ = lean_nat_dec_lt(v___y_5467_, v___x_5470_);
if (v___x_5471_ == 0)
{
