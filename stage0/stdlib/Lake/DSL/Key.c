...
v_methods_488_ = lean_ctor_get(v___y_485_, 0);
v_quotContext_489_ = lean_ctor_get(v___y_485_, 1);
v_currMacroScope_490_ = lean_ctor_get(v___y_485_, 2);
v_currRecDepth_491_ = lean_ctor_get(v___y_485_, 3);
v_maxRecDepth_492_ = lean_ctor_get(v___y_485_, 4);
v_ref_493_ = lean_ctor_get(v___y_485_, 5);
