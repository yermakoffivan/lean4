...
lean_inc(v___y_359_);
v___x_365_ = lean_alloc_ctor(0, 22, 0);
...
lean_ctor_set(v___x_365_, 14, v___y_359_);
...
lean_ctor_set(v___x_365_, 19, v___y_362_);
lean_ctor_set(v___x_365_, 20, v_testDriver_363_);
lean_ctor_set(v___x_365_, 21, v_lintDriver_364_);
return v___x_365_;
}
v___jp_366_:
{
...
v_buildArchive_704_ = lean_ctor_get(v_self_702_, 19);
...
v_targetDeclMap_939_ = lean_ctor_get(v_self_938_, 14);
...
v_targetDecls_985_ = lean_ctor_get(v_self_984_, 13);
...
v_targetDecls_1031_ = lean_ctor_get(v_self_1030_, 13);
