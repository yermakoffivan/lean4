...
lean_inc_ref_n(v___y_2548_, 2);
v___x_2553_ = l_Array_append___redArg(v___y_2548_, v___y_2552_);
lean_dec_ref(v___y_2552_);
lean_inc_n(v___y_2551_, 3);
lean_inc_n(v___y_2538_, 9);
v___x_2554_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2554_, 0, v___y_2538_);
lean_ctor_set(v___x_2554_, 1, v___y_2551_);
...
v___x_2562_ = l_Nat_reprFast(v___y_2544_);
...
v___x_2568_ = l_Lean_Syntax_node1(v___y_2538_, v___y_2551_, v___x_2567_);
v_sz_2569_ = lean_array_size(v___y_2537_);
v___x_2570_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Elab_Command_elabNotation_spec__3(v_sz_2569_, v___y_2543_, v___y_2537_);
v___x_2571_ = l_Array_append___redArg(v___y_2548_, v___x_2570_);
lean_dec_ref(v___x_2570_);
v___x_2572_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2572_, 0, v___y_2538_);
lean_ctor_set(v___x_2572_, 1, v___y_2551_);
...
v___x_2578_ = lean_array_push(v___x_2577_, v___y_2541_);
lean_inc(v___y_2549_);
v___x_2579_ = lean_array_push(v___x_2578_, v___y_2549_);
v___x_2580_ = lean_array_push(v___x_2579_, v___y_2534_);
v___x_2581_ = lean_array_push(v___x_2580_, v___y_2547_);
...
v___x_2586_ = lean_array_push(v___x_2585_, v___y_2535_);
lean_inc(v___y_2539_);
v___x_2587_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2587_, 0, v___y_2538_);
lean_ctor_set(v___x_2587_, 1, v___y_2539_);
lean_ctor_set(v___x_2587_, 2, v___x_2586_);
v___x_2588_ = l_Lean_Elab_Command_elabSyntax(v___x_2587_, v___y_2540_, v___y_2536_);
...
v___x_2595_ = l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_Elab_Command_elabNotation_spec__8(v___y_2545_, v___y_2543_, v___x_2594_, v___x_2591_);
v___y_2476_ = v___y_2536_;
v___y_2477_ = v_a_2589_;
v___y_2478_ = v___x_2563_;
v___y_2479_ = v___x_2565_;
...
v___x_2597_ = l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_Elab_Command_elabNotation_spec__8(v___y_2545_, v___y_2543_, v___x_2596_, v___x_2591_);
v___y_2476_ = v___y_2536_;
v___y_2477_ = v_a_2589_;
v___y_2478_ = v___x_2563_;
v___y_2479_ = v___x_2565_;
...
v_val_2629_ = lean_ctor_get(v___y_2615_, 0);
...
lean_inc_n(v___y_2647_, 2);
v___x_2664_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2664_, 0, v___y_2647_);
lean_ctor_set(v___x_2664_, 1, v___y_2661_);
lean_ctor_set(v___x_2664_, 2, v___x_2663_);
lean_inc_ref(v___y_2649_);
v___x_2665_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_2665_, 0, v___y_2647_);
lean_ctor_set(v___x_2665_, 1, v___y_2649_);
if (lean_obj_tag(v___y_2657_) == 1)
{
...
v_val_2666_ = lean_ctor_get(v___y_2657_, 0);
...
lean_ctor_set(v___x_2669_, 0, v___y_2647_);
lean_ctor_set(v___x_2669_, 1, v___x_2668_);
v___x_2670_ = l_Lean_Syntax_node2(v___y_2647_, v___x_2667_, v___x_2669_, v_val_2666_);
...
v___y_2616_ = v___x_2664_;
v___y_2617_ = v___y_2653_;
v___y_2618_ = v___y_2652_;
...
v___x_2694_ = l_Array_append___redArg(v___y_2689_, v___y_2693_);
...
v_val_2696_ = lean_ctor_get(v___y_2675_, 0);
lean_inc(v_val_2696_);
lean_dec_ref(v___y_2675_);
v___x_2697_ = ((lean_object*)(l_Lean_Elab_Command_mkUnexpander___closed__11));
lean_inc_ref(v___y_2687_);
v___x_2698_ = l_Lean_Name_mkStr4(v___x_2418_, v___x_2419_, v___y_2687_, v___x_2697_);
v___x_2699_ = ((lean_object*)(l_Lean_Elab_Command_mkUnexpander___closed__13));
lean_inc_n(v___y_2678_, 4);
v___x_2700_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_2700_, 0, v___y_2678_);
lean_ctor_set(v___x_2700_, 1, v___x_2699_);
lean_inc_ref(v___y_2689_);
v___x_2701_ = l_Array_append___redArg(v___y_2689_, v_val_2696_);
lean_dec(v_val_2696_);
lean_inc(v___y_2692_);
v___x_2702_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2702_, 0, v___y_2678_);
lean_ctor_set(v___x_2702_, 1, v___y_2692_);
...
lean_ctor_set(v___x_2704_, 0, v___y_2678_);
lean_ctor_set(v___x_2704_, 1, v___x_2703_);
v___x_2705_ = l_Lean_Syntax_node3(v___y_2678_, v___x_2698_, v___x_2700_, v___x_2702_, v___x_2704_);
...
v_val_2729_ = lean_ctor_get(v___y_2719_, 0);
...
v___y_2689_ = v___x_2728_;
v___y_2690_ = v___y_2723_;
v___y_2691_ = v___y_2724_;
v___y_2692_ = v___x_2727_;
...
v___x_2813_ = l_Lean_Syntax_matchesNull(v___x_2811_, v___y_2801_);
if (v___x_2813_ == 0)
{
...
v_prio_x3f_2819_ = l_Lean_Syntax_getArg(v___x_2815_, v___y_2803_);
lean_dec(v___x_2815_);
...
v___y_2735_ = v___y_2804_;
v___y_2736_ = v___y_2805_;
...
v___x_2835_ = l_Lean_Syntax_matchesNull(v___x_2833_, v___y_2824_);
if (v___x_2835_ == 0)
{
...
v_name_x3f_2841_ = l_Lean_Syntax_getArg(v___x_2837_, v___y_2826_);
lean_dec(v___x_2837_);
...
v___y_2823_ = v_attrs_x3f_2847_;
v___y_2824_ = v___y_2845_;
v___y_2825_ = v___y_2846_;
v___y_2826_ = v___x_2856_;
v___y_2827_ = v___x_2852_;
v___y_2828_ = v_attrKind_2851_;
...
lean_closure_set(v___x_2397_, 1, v___y_2392_);
lean_closure_set(v___x_2397_, 2, v___y_2393_);
...
lean_ctor_set(v___x_2435_, 2, v___y_2429_);
...
v___x_2438_ = l_Lean_Name_mkStr4(v___x_2418_, v___x_2419_, v___y_2426_, v___x_2437_);
v___x_2439_ = ((lean_object*)(l_Lean_Elab_Command_mkUnexpander___closed__31));
v___x_2440_ = l_Lean_Name_mkStr4(v___x_2418_, v___x_2419_, v___y_2426_, v___x_2439_);
...
v___x_2444_ = l_Lean_Name_mkStr4(v___x_2418_, v___x_2419_, v___y_2426_, v___x_2443_);
...
lean_ctor_set(v___x_2447_, 1, v___y_2425_);
lean_inc_ref(v___x_2447_);
lean_inc(v___y_2424_);
lean_inc_ref(v___x_2446_);
lean_inc(v___x_2444_);
v___x_2448_ = l_Lean_Syntax_node3(v___y_2427_, v___x_2444_, v___x_2446_, v___y_2424_, v___x_2447_);
v___x_2449_ = l_Lean_Syntax_node1(v___y_2427_, v___y_2432_, v___x_2448_);
v___x_2450_ = l_Lean_Syntax_node1(v___y_2427_, v___y_2432_, v___x_2449_);
...
v___x_2454_ = l_Lean_Name_mkStr4(v___x_2418_, v___x_2419_, v___y_2426_, v___x_2453_);
...
v___x_2457_ = l_Lean_Syntax_node3(v___y_2427_, v___x_2444_, v___x_2446_, v___y_2431_, v___x_2447_);
...
v___x_2460_ = l_Lean_Syntax_node1(v___y_2427_, v___y_2432_, v___x_2459_);
v___x_2461_ = l_Lean_Syntax_node1(v___y_2427_, v___x_2438_, v___x_2460_);
lean_inc_n(v___y_2430_, 2);
lean_inc_ref_n(v___x_2435_, 2);
v___x_2462_ = l_Lean_Syntax_node6(v___y_2427_, v___x_2434_, v___x_2435_, v___x_2435_, v___y_2430_, v___x_2436_, v___x_2435_, v___x_2461_);
v___x_2463_ = l_Lean_Elab_Command_isLocalAttrKind(v___y_2430_);
if (v___x_2463_ == 0)
{
lean_object* v___x_2464_; 
v___x_2464_ = l_Lean_Elab_Command_elabCommand(v___x_2462_, v___y_2428_, v___y_2423_);
if (lean_obj_tag(v___x_2464_) == 0)
{
lean_dec_ref(v___x_2464_);
v___y_2392_ = v___y_2424_;
v___y_2393_ = v___y_2431_;
...
v___x_2474_ = l_Lean_Elab_Command_withScope___redArg(v___f_2472_, v___x_2473_, v___y_2428_, v___y_2423_);
...
v_sz_2490_ = lean_array_size(v___y_2483_);
v___x_2491_ = lean_box_usize(v_sz_2490_);
v___x_2492_ = lean_box_usize(v___y_2481_);
...
lean_closure_set(v___x_2493_, 2, v___y_2483_);
v___x_2494_ = l_Lean_Elab_liftMacroM___at___00Lean_Elab_Command_elabNotation_spec__1___redArg(v___x_2493_, v___y_2480_, v___y_2476_);
...
v___x_2496_ = l_Lean_Elab_Command_getRef___redArg(v___y_2480_);
...
v___x_2498_ = l_Lean_Elab_Command_getCurrMacroScope___redArg(v___y_2480_);
...
v_quotContext_x3f_2499_ = lean_ctor_get(v___y_2480_, 5);
v_sz_2500_ = lean_array_size(v___y_2489_);
v___x_2501_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Elab_Command_elabNotation_spec__5(v_sz_2500_, v___y_2481_, v___y_2489_);
v___x_2502_ = l___private_Lean_Elab_Notation_0__Lean_Elab_Command_antiquote(v___x_2501_, v___y_2488_);
...
v___x_2504_ = l_Lean_SourceInfo_fromRef(v_a_2497_, v___y_2482_);
lean_dec(v_a_2497_);
if (lean_obj_tag(v_quotContext_x3f_2499_) == 0)
{
lean_object* v___x_2505_; 
v___x_2505_ = l_Lean_getMainModule___at___00Lean_Elab_Command_elabNotation_spec__7___redArg(v___y_2476_);
lean_dec_ref(v___x_2505_);
v___y_2423_ = v___y_2476_;
v___y_2424_ = v___x_2503_;
v___y_2425_ = v___y_2479_;
v___y_2426_ = v___y_2484_;
v___y_2427_ = v___x_2504_;
v___y_2428_ = v___y_2480_;
v___y_2429_ = v___y_2485_;
v___y_2430_ = v___y_2486_;
v___y_2431_ = v___x_2502_;
