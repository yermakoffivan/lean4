...
v___x_7081_ = l_String_compare(v_k_7076_, v_k_7078_);
switch(v___x_7081_)
{
case 0:
{
...
{
uint8_t v___x_7112_; 
v___x_7112_ = l_String_compare(v_k_7101_, v_k_7105_);
switch(v___x_7112_)
{
case 0:
{
