...
static lean_once_cell_t l_instNatCastNat___closed__0_once = LEAN_ONCE_CELL_INITIALIZER;
...
static lean_object* _init_l_instNatCastNat___closed__0(void){
_start:
{
lean_object* v___f_4_; 
v___f_4_ = lean_alloc_closure((void*)(l_instNatCastNat___lam__0___boxed), 1, 0);
return v___f_4_;
}
}
static lean_object* _init_l_instNatCastNat(void){
_start:
{
lean_object* v___f_5_; 
v___f_5_ = lean_obj_once(&l_instNatCastNat___closed__0, &l_instNatCastNat___closed__0_once, _init_l_instNatCastNat___closed__0);
return v___f_5_;
}
}
