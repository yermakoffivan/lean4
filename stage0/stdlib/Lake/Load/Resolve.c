...
{
uint8_t v___x_3231_; 
v___x_3231_ = l_String_compare(v_k_3220_, v_k_3224_);
switch(v___x_3231_)
{
case 0:
{
...
lean_dec_ref(v_packagesDir_x3f_5598_);
v___y_5601_ = v___y_5615_;
