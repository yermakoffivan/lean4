...
lean_ctor_set(v___x_833_, 2, v___y_812_);
...
lean_ctor_set_uint8(v___x_833_, sizeof(void*)*5 + 1, v___y_810_);
...
lean_inc_ref_n(v___y_844_, 2);
v___x_857_ = l_Lean_FileMap_toPosition(v___y_844_, v___y_849_);
lean_dec(v___y_849_);
v___x_858_ = l_Lean_FileMap_toPosition(v___y_844_, v___y_850_);
lean_dec(v___y_850_);
...
v___x_876_ = l_Lean_Syntax_getTailPos_x3f(v___y_871_, v___y_870_);
lean_dec(v___y_871_);
