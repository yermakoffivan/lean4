...
v___x_256_ = lean_nat_add(v___y_251_, v___y_249_);
lean_dec(v___y_249_);
lean_dec(v___y_251_);
...
v___x_265_ = l_Int_repr(v___y_250_);
lean_dec(v___y_250_);
...
lean_ctor_set(v___x_1638_, 3, v___y_1656_);
...
lean_ctor_set(v_reuseFailAlloc_1664_, 3, v___y_1656_);
