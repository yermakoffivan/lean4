...
@[backward_defeq, simp, grind =] theorem isLeft_inl : (inl x : α ⊕ β).isLeft = true := rfl
@[backward_defeq, simp, grind =] theorem isLeft_inr : (inr x : α ⊕ β).isLeft = false := rfl
@[backward_defeq, simp, grind =] theorem isRight_inl : (inl x : α ⊕ β).isRight = false := rfl
@[backward_defeq, simp, grind =] theorem isRight_inr : (inr x : α ⊕ β).isRight = true := rfl

@[backward_defeq, simp, grind =] theorem getLeft_inl (h : (inl x : α ⊕ β).isLeft) : (inl x).getLeft h = x := rfl
@[backward_defeq, simp, grind =] theorem getRight_inr (h : (inr x : α ⊕ β).isRight) : (inr x).getRight h = x := rfl

@[backward_defeq, simp, grind =] theorem getLeft?_inl : (inl x : α ⊕ β).getLeft? = some x := rfl
@[backward_defeq, simp, grind =] theorem getLeft?_inr : (inr x : α ⊕ β).getLeft? = none := rfl
@[backward_defeq, simp, grind =] theorem getRight?_inl : (inl x : α ⊕ β).getRight? = none := rfl
@[backward_defeq, simp, grind =] theorem getRight?_inr : (inr x : α ⊕ β).getRight? = some x := rfl
...
@[backward_defeq, simp, grind =] theorem elim_inl (f : α → γ) (g : β → γ) (x : α) :
    Sum.elim f g (inl x) = f x := rfl

@[backward_defeq, simp, grind =] theorem elim_inr (f : α → γ) (g : β → γ) (x : β) :
...
@[backward_defeq, simp, grind =] theorem map_inl (f : α → α') (g : β → β') (x : α) : (inl x).map f g = inl (f x) := rfl

@[backward_defeq, simp, grind =] theorem map_inr (f : α → α') (g : β → β') (x : β) : (inr x).map f g = inr (g x) := rfl
...
@[backward_defeq, simp, grind =] theorem swap_inl : swap (inl x : α ⊕ β) = inr x := rfl

@[backward_defeq, simp, grind =] theorem swap_inr : swap (inr x : α ⊕ β) = inl x := rfl
