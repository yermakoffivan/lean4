...
v___x_3134_ = l_String_instDecidableLtRaw___aux__1(v_hoverPos_3118_, v_val_3133_);
if (v___x_3134_ == 0)
{
...
uint8_t v___x_3277_; 
lean_dec(v_gs_3240_);
v___x_3277_ = l_String_instDecidableLtRaw___aux__1(v_val_3250_, v_hoverPos_3235_);
if (v___x_3277_ == 0)
{
lean_dec(v_val_3252_);
