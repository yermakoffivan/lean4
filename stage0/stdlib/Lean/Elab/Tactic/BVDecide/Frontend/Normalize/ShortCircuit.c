...
_start:
{
uint8_t v___x_5334__boxed_222_; uint8_t v___x_5335__boxed_223_; lean_object* v_res_224_; 
v___x_5334__boxed_222_ = lean_unbox(v___x_205_);
v___x_5335__boxed_223_ = lean_unbox(v___x_206_);
v_res_224_ = l_Lean_Elab_Tactic_BVDecide_Frontend_Normalize_shortCircuitPass___lam__0(v_theorems_201_, v___x_202_, v___x_203_, v___x_204_, v___x_5334__boxed_222_, v___x_5335__boxed_223_, v___x_207_, v___x_208_, v___x_209_, v___x_210_, v___x_211_, v___x_212_, v___x_213_, v_goal_214_, v___y_215_, v___y_216_, v___y_217_, v___y_218_, v___y_219_, v___y_220_);
lean_dec(v___y_220_);
