...
v___x_353_ = lean_mk_string_unchecked("A private declaration `", 23, 23);
return v___x_353_;
}
}
...
v___x_356_ = lean_mk_string_unchecked("` (from the current module) exists but would need to be public to access here.", 78, 78);
return v___x_356_;
}
}
...
v___x_359_ = lean_mk_string_unchecked("A public declaration `", 22, 22);
return v___x_359_;
}
}
...
v___x_362_ = lean_mk_string_unchecked("` exists but is imported privately; consider adding `public import ", 67, 67);
return v___x_362_;
}
}
...
v___x_365_ = lean_mk_string_unchecked("`.", 2, 2);
return v___x_365_;
}
}
...
v___x_368_ = lean_mk_string_unchecked("` (from `", 9, 9);
return v___x_368_;
}
}
...
v___x_371_ = lean_mk_string_unchecked("`) exists but would need to be public to access here.", 53, 53);
return v___x_371_;
}
}
