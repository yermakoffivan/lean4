...
lean_inc_ref(v_lctx_990_);
v___x_999_ = l___private_Lean_Meta_Sym_ReplaceS_0__Lean_Meta_Sym_visit___at___00Lean_Meta_Sym_abstractFVarsRange_spec__5(v___y_994_, v_lctx_990_, v___x_942_, v_start_935_, v_xs_936_, v_maxFVar_991_, v_e_934_, v___y_995_, v___x_998_, v_debug_992_, v_snd_996_);
lean_dec_ref(v_maxFVar_991_);
lean_dec(v___y_994_);
