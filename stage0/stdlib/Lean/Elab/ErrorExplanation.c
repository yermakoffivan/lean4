...
v___x_3402_ = l_Lean_Syntax_getTailPos_x3f(v_id_3393_, v___y_3397_);
lean_dec(v_id_3393_);
...
v___x_3366_ = l_Lean_DeclarationRange_ofStringPositions(v___y_3337_, v___y_3341_, v___y_3342_);
...
lean_ctor_set(v___x_3371_, 0, v___y_3336_);
