...
LEAN_EXPORT lean_object* runtime_initialize_Lean_Elab_Tactic_Do_Internal_VCGen(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Elab_Tactic_Do_Internal_VCGen(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Lean_Elab_Tactic_Do_Internal_VCGen(uint8_t builtin) {
lean_object * res;
