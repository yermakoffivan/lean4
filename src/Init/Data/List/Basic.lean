...
@[backward_defeq, simp, grind =] theorem foldl_nil : [].foldl f b = b := rfl
@[backward_defeq, simp, grind =] theorem foldl_cons {l : List α} {f : β → α → β} {b : β} : (a :: l).foldl f b = l.foldl f (f b a) := rfl
...
@[backward_defeq, simp] theorem beq_nil_nil [BEq α] : List.beq ([] : List α) ([] : List α) = true := rfl
@[backward_defeq, simp] theorem beq_cons_nil [BEq α] {a : α} {as : List α} : List.beq (a::as) [] = false := rfl
@[backward_defeq, simp] theorem beq_nil_cons [BEq α] {a : α} {as : List α} : List.beq [] (a::as) = false := rfl
@[backward_defeq]
...
@[backward_defeq, simp, grind =] theorem isEqv_nil_nil : isEqv ([] : List α) [] eqv = true := rfl
@[backward_defeq, simp, grind =] theorem isEqv_nil_cons : isEqv ([] : List α) (a::as) eqv = false := rfl
@[backward_defeq, simp, grind =] theorem isEqv_cons_nil : isEqv (a::as : List α) [] eqv = false := rfl
@[backward_defeq, grind =] theorem isEqv_cons_cons : isEqv (a::as) (b::bs) eqv = (eqv a b && isEqv as bs eqv) := rfl
...
@[backward_defeq, simp] theorem nil_lex_cons [BEq α] {b} {bs : List α} : lex [] (b :: bs) lt = true := rfl
@[backward_defeq]
theorem cons_lex_nil [BEq α] {a} {as : List α} : lex (a :: as) [] lt = false := rfl
@[backward_defeq, simp] theorem cons_lex_cons [BEq α] {a b} {as bs : List α} :
...
@[backward_defeq, simp, grind =] theorem getLast?_nil : @getLast? α [] = none := rfl
...
@[backward_defeq, simp, grind =] theorem head_cons {a : α} {l : List α} {h} : head (a::l) h = a := rfl
...
@[backward_defeq, simp, grind =] theorem head?_nil : head? ([] : List α) = none := rfl
@[backward_defeq, simp, grind =] theorem head?_cons {a : α} {l : List α} : head? (a::l) = some a := rfl
...
@[backward_defeq, simp] theorem headD_nil {d : α} : headD [] d = d := rfl
@[backward_defeq, simp] theorem headD_cons {a : α} {l : List α} {d : α} : headD (a::l) d = a := rfl
...
@[backward_defeq, simp, grind =] theorem tail_nil : tail ([] : List α) = [] := rfl
@[backward_defeq, simp, grind =] theorem tail_cons {a : α} {as : List α} : tail (a::as) = as := rfl
...
@[backward_defeq, simp, grind =] theorem tail?_nil : tail? ([] : List α) = none := rfl
@[backward_defeq, simp, grind =] theorem tail?_cons {a : α} {l : List α} : tail? (a::l) = some l := rfl
...
@[backward_defeq, simp] theorem tailD_nil {l' : List α} : tailD [] l' = l' := rfl
@[backward_defeq, simp] theorem tailD_cons {a : α} {l : List α} {l' : List α} : tailD (a::l) l' = l := rfl
...
@[backward_defeq, simp, grind =] theorem map_nil {f : α → β} : map f [] = [] := rfl
@[backward_defeq, simp, grind =] theorem map_cons {f : α → β} {a : α} {l : List α} : map f (a :: l) = f a :: map f l := rfl
...
@[backward_defeq, simp, grind =] theorem filter_nil {p : α → Bool} : filter p [] = [] := rfl
...
@[backward_defeq, simp, grind =] theorem filterMap_nil {f : α → Option β} : filterMap f [] = [] := rfl
@[backward_defeq, grind =] theorem filterMap_cons {f : α → Option β} {a : α} {l : List α} :
    filterMap f (a :: l) =
      match f a with
      | none => filterMap f l
...
@[backward_defeq, simp, grind =] theorem foldr_nil : [].foldr f b = b := rfl
@[backward_defeq, simp, grind =] theorem foldr_cons {a} {l : List α} {f : α → β → β} {b} :
...
@[backward_defeq, simp] theorem reverseAux_nil : reverseAux [] r = r := rfl
@[backward_defeq, simp] theorem reverseAux_cons : reverseAux (a::l) r = reverseAux l (a::r) := rfl
...
@[backward_defeq, simp, grind =] theorem reverse_nil : reverse ([] : List α) = [] := rfl
...
@[backward_defeq, simp, grind =] theorem nil_append (as : List α) : [] ++ as = as := rfl
@[backward_defeq, simp, grind _=_] theorem cons_append {a : α} {as bs : List α} : (a::as) ++ bs = a::(as ++ bs) := rfl
...
@[backward_defeq, simp, grind =] theorem flatten_nil : List.flatten ([] : List (List α)) = [] := rfl
@[backward_defeq, simp, grind =] theorem flatten_cons : (l :: L).flatten = l ++ L.flatten := rfl
...
@[backward_defeq, simp, grind =] theorem replicate_zero {a : α} : replicate 0 a = [] := rfl
@[backward_defeq, grind =] theorem replicate_succ {a : α} {n : Nat} : replicate (n+1) a = a :: replicate n a := rfl
...
@[backward_defeq, simp, grind =] theorem isEmpty_nil : ([] : List α).isEmpty = true := rfl
@[backward_defeq, simp, grind =] theorem isEmpty_cons : (x :: xs : List α).isEmpty = false := rfl
...
@[backward_defeq, simp, grind =] theorem elem_nil [BEq α] : ([] : List α).elem a = false := rfl
@[backward_defeq]
...
@[backward_defeq, simp] theorem contains_nil [BEq α] : ([] : List α).contains a = false := rfl
...
@[backward_defeq, simp, grind =] theorem take_zero {l : List α} : l.take 0 = [] := rfl
@[backward_defeq, simp, grind =] theorem take_succ_cons {a : α} {as : List α} {i : Nat} :
...
@[simp, grind =] theorem drop_nil : ([] : List α).drop i = [] := by
  cases i <;> rfl
@[backward_defeq, simp, grind =] theorem drop_zero {l : List α} : l.drop 0 = l := rfl
@[backward_defeq, simp, grind =] theorem drop_succ_cons {a : α} {l : List α} {i : Nat} : (a :: l).drop (i + 1) = l.drop i := rfl
...
@[backward_defeq, simp] theorem takeWhile_nil : ([] : List α).takeWhile p = [] := rfl
...
@[backward_defeq, simp] theorem dropWhile_nil : ([] : List α).dropWhile p = [] := rfl
...
@[backward_defeq, simp, grind =] theorem dropLast_nil : ([] : List α).dropLast = [] := rfl
@[backward_defeq, simp, grind =] theorem dropLast_singleton : [x].dropLast = [] := rfl

@[backward_defeq, simp, grind =] theorem dropLast_cons_cons :
...
@[simp, grind =] theorem isPrefixOf_nil_left [BEq α] : isPrefixOf ([] : List α) l = true := by
  simp [isPrefixOf]
@[backward_defeq, simp, grind =] theorem isPrefixOf_cons_nil [BEq α] : isPrefixOf (a::as) ([] : List α) = false := rfl
@[backward_defeq, grind =] theorem isPrefixOf_cons_cons [BEq α] {a : α} :
...
@[backward_defeq, simp] theorem rotateLeft_nil : ([] : List α).rotateLeft n = [] := rfl
...
@[backward_defeq, simp] theorem rotateRight_nil : ([] : List α).rotateRight n = [] := rfl
...
@[backward_defeq, simp, grind =] theorem replace_nil [BEq α] : ([] : List α).replace a b = [] := rfl
...
@[backward_defeq, simp] theorem modifyTailIdx_zero {l : List α} : l.modifyTailIdx 0 f = f l := rfl
@[backward_defeq, simp] theorem modifyTailIdx_succ_nil {i : Nat} : ([] : List α).modifyTailIdx (i + 1) f = [] := rfl
@[backward_defeq, simp] theorem modifyTailIdx_succ_cons {i : Nat} {a : α} {l : List α} :
...
@[backward_defeq, simp, grind =] theorem erase_nil [BEq α] (a : α) : [].erase a = [] := rfl
...
@[backward_defeq, simp] theorem eraseIdx_nil : ([] : List α).eraseIdx i = [] := rfl
@[backward_defeq, simp] theorem eraseIdx_cons_zero : (a::as).eraseIdx 0 = as := rfl
@[backward_defeq, simp] theorem eraseIdx_cons_succ : (a::as).eraseIdx (i+1) = a :: as.eraseIdx i := rfl
...
@[backward_defeq, simp, grind =] theorem find?_nil : ([] : List α).find? p = none := rfl
...
@[backward_defeq, simp, grind =] theorem findSome?_nil : ([] : List α).findSome? f = none := rfl
...
@[backward_defeq, simp] theorem findIdx_nil {p : α → Bool} : [].findIdx p = 0 := rfl
...
@[backward_defeq, simp] theorem idxOf_nil [BEq α] : ([] : List α).idxOf x = 0 := rfl
...
@[backward_defeq, simp, grind =] theorem lookup_nil [BEq α] : ([] : List (α × β)).lookup a = none := rfl
...
@[backward_defeq, simp, grind =] theorem any_nil : [].any f = false := rfl
@[backward_defeq, simp, grind =] theorem any_cons : (a::l).any f = (f a || l.any f) := rfl
...
@[backward_defeq, simp, grind =] theorem all_nil : [].all f = true := rfl
@[backward_defeq, simp, grind =] theorem all_cons : (a::l).all f = (f a && l.all f) := rfl
...
@[backward_defeq, simp] theorem or_nil : [].or = false := rfl
@[backward_defeq, simp] theorem or_cons : (a::l).or = (a || l.or) := rfl
...
@[backward_defeq, simp] theorem and_nil : [].and = true := rfl
@[backward_defeq, simp] theorem and_cons : (a::l).and = (a && l.and) := rfl
...
@[backward_defeq, simp] theorem zipWith_nil_left {f : α → β → γ} : zipWith f [] l = [] := rfl
@[simp] theorem zipWith_nil_right {f : α → β → γ} : zipWith f l [] = [] := by simp [zipWith]
@[backward_defeq, simp] theorem zipWith_cons_cons {f : α → β → γ} :
...
@[backward_defeq, simp] theorem zip_nil_left : zip ([] : List α) (l : List β)  = [] := rfl
@[simp] theorem zip_nil_right : zip (l : List α) ([] : List β)  = [] := by simp [zip]
@[backward_defeq, simp] theorem zip_cons_cons : zip (a :: as) (b :: bs) = (a, b) :: zip as bs := rfl
...
@[simp] theorem zipWithAll_nil :
  ...
  cases as <;> rfl
@[backward_defeq, simp] theorem nil_zipWithAll :
    zipWithAll f [] bs = bs.map fun b => f none (some b) := rfl
@[backward_defeq, simp] theorem zipWithAll_cons_cons :
...
@[backward_defeq, simp] theorem unzip_nil : ([] : List (α × β)).unzip = ([], []) := rfl
@[backward_defeq, simp] theorem unzip_cons {h : α × β} :
...
@[backward_defeq, simp, grind =] theorem sum_nil [Add α] [Zero α] : ([] : List α).sum = 0 := rfl
@[backward_defeq, simp, grind =] theorem sum_cons [Add α] [Zero α] {a : α} {l : List α} : (a::l).sum = a + l.sum := rfl
@[backward_defeq]
...
@[backward_defeq, simp, grind =] theorem prod_nil [Mul α] [One α] : ([] : List α).prod = 1 := rfl
@[backward_defeq, simp, grind =] theorem prod_cons [Mul α] [One α] {a : α} {l : List α} : (a::l).prod = a * l.prod := rfl
@[backward_defeq]
...
@[backward_defeq, simp, grind =] theorem range_zero : range 0 = [] := rfl
...
@[backward_defeq, simp, grind =] theorem range'_zero : range' s 0 step = [] := rfl
@[backward_defeq, simp, grind =] theorem range'_one {s step : Nat} : range' s 1 step = [s] := rfl
...
@[backward_defeq, simp] theorem zipIdx_nil : ([] : List α).zipIdx i = [] := rfl
@[backward_defeq, simp] theorem zipIdx_cons : (a::as).zipIdx i = (a, i) :: as.zipIdx (i+1) := rfl
...
@[backward_defeq, simp] theorem intersperse_nil {sep : α} : ([] : List α).intersperse sep = [] := rfl
@[backward_defeq, simp] theorem intersperse_singleton {x : α} {sep : α} : [x].intersperse sep = [x] := rfl
@[backward_defeq, deprecated intersperse_singleton (since := "2026-02-26")]
theorem intersperse_single {x : α} {sep : α} : [x].intersperse sep = [x] := rfl
@[backward_defeq, simp] theorem intersperse_cons_cons {x : α} {y : α} {zs : List α} {sep : α} :
...
@[backward_defeq, simp] theorem nil_removeAll [BEq α] {ys : List α} : [].removeAll ys = [] := rfl
