...
lean_ctor_set(v___x_1276_, 0, v___y_1269_);
...
v___x_1291_ = lean_nat_sub(v___y_1285_, v___y_1289_);
...
v___x_1294_ = lean_array_fget_borrowed(v___y_1286_, v___x_1291_);
lean_dec(v___x_1291_);
