...
@[backward_defeq, simp, grind =] theorem getD_none : getD none a = a := rfl
@[backward_defeq, simp, grind =] theorem getD_some : getD (some a) b = a := rfl

@[backward_defeq, simp, grind =] theorem map_none (f : α → β) : none.map f = none := rfl
@[backward_defeq, simp, grind =] theorem map_some (a) (f : α → β) : (some a).map f = some (f a) := rfl
...
@[backward_defeq, simp, grind =] theorem getM_none [Alternative m] : getM none = (failure : m α) := rfl
@[backward_defeq, simp, grind =] theorem getM_some [Alternative m] {a : α} : getM (some a) = (pure a : m α) := rfl
...
@[backward_defeq, simp, grind =] theorem isSome_none : @isSome α none = false := rfl
@[backward_defeq, simp, grind =] theorem isSome_some : isSome (some a) = true := rfl
...
@[backward_defeq, simp, grind =] theorem isNone_none : @isNone α none = true := rfl
@[backward_defeq, simp, grind =] theorem isNone_some : isNone (some a) = false := rfl
...
@[backward_defeq, simp, grind =] theorem bind_none (f : α → Option β) : none.bind f = none := rfl
@[backward_defeq, simp, grind =] theorem bind_some (a) (f : α → Option β) : (some a).bind f = f a := rfl
...
@[backward_defeq, simp, grind =] theorem mapM_none [Applicative m] (f : α → m β) : none.mapM f = pure none := rfl
@[backward_defeq, simp, grind =] theorem mapM_some [Applicative m] (x) (f : α → m β) : (some x).mapM f = some <$> f x := rfl
...
@[backward_defeq, simp, grind =] theorem mapA_eq_mapM [Applicative m] {f : α → m β} : Option.mapA f o = Option.mapM f o := rfl
...
@[backward_defeq, simp, grind =] theorem all_none : Option.all p none = true := rfl
@[backward_defeq, simp, grind =] theorem all_some : Option.all p (some x) = p x := rfl
...
@[backward_defeq, simp, grind =] theorem any_none : Option.any p none = false := rfl
@[backward_defeq, simp, grind =] theorem any_some : Option.any p (some x) = p x := rfl
...
@[backward_defeq, simp, grind =] theorem orElse_some : (some a).orElse b = some a := rfl
@[backward_defeq, simp, grind =] theorem orElse_none : none.orElse b = b () := rfl
...
| some _, _ => rfl
@[backward_defeq, simp, grind =] theorem get_some (x : α) (h : isSome (some x)) : (some x).get h = x := rfl
...
@[backward_defeq, simp, grind =] theorem join_none : (none : Option (Option α)).join = none := rfl
@[backward_defeq, simp, grind =] theorem join_some : (some o).join = o := rfl
...
@[backward_defeq, simp, grind =] theorem sequence_none [Applicative m] : (none : Option (m α)).sequence = pure none := rfl
@[backward_defeq, simp, grind =] theorem sequence_some [Applicative m] (f : m α) : (some f).sequence = some <$> f := rfl
...
@[backward_defeq, simp, grind =] theorem getDM_none [Pure m] (y : m α) : (none : Option α).getDM y = y := rfl
@[backward_defeq, simp, grind =] theorem getDM_some [Pure m] (a : α) (y : m α) : (some a).getDM y = pure a := rfl
...
@[backward_defeq, simp, grind =] theorem min_some_some [Min α] {a b : α} : min (some a) (some b) = some (min a b) := rfl
...
@[backward_defeq, simp, grind =] theorem max_some_some [Max α] {a b : α} : max (some a) (some b) = some (max a b) := rfl
