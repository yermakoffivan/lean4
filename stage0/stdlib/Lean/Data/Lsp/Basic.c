...
v___x_167_ = l_String_compare(v_uri_163_, v_uri_165_);
if (v___x_167_ == 1)
{
uint8_t v___x_168_; 
...
lean_dec_ref(v_changes_x3f_3276_);
...
lean_dec_ref(v_changeAnnotations_x3f_3278_);
...
lean_dec_ref(v_documentChanges_x3f_3277_);
