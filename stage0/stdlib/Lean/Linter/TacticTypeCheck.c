...
lean_ctor_set(v___x_582_, 1, v___y_554_);
lean_ctor_set(v___x_582_, 2, v___y_553_);
...
lean_ctor_set_uint8(v___x_582_, sizeof(void*)*5 + 1, v___y_552_);
