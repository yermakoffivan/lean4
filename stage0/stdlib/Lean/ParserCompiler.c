...
lean_dec_ref_known(v___x_780_, 14);
return v___x_781_;
}
}
...
lean_dec_ref_known(v_x_1541_, 3);
...
lean_dec_ref_known(v_x_1541_, 4);
v_x_1541_ = v_p_1564_;
goto _start;
}
case 8:
...
lean_dec_ref_known(v___x_2016_, 7);
...
lean_dec_ref_known(v___x_1970_, 7);
