...
lean_dec(v___y_996_);
v_toSignature_1005_ = lean_ctor_get(v___y_1000_, 0);
...
lean_del_object(v___x_964_);
lean_dec(v_declName_961_);
v___x_1007_ = l_Lean_Compiler_LCNF_argsToMonoRedArg(v_args_962_, v___y_1003_, v___y_997_, v___y_998_, v___y_999_, v___y_1002_, v___y_995_, v___y_1001_);
lean_dec_ref(v___y_997_);
lean_dec_ref(v___y_1003_);
...
lean_ctor_set(v___x_1013_, 0, v___y_996_);
...
if (v___x_1053_ == 0)
{
v___y_995_ = v___y_1030_;
v___y_996_ = v___x_1052_;
v___y_997_ = v_args_1049_;
v___y_998_ = v___y_1027_;
v___y_999_ = v___y_1028_;
v___y_1000_ = v_val_1035_;
