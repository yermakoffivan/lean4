...
partial instance : ToSnapshotTree TacticParsedSnapshot where
  ...
  where go s :=
    withReader (·.compose s.transformed.transform) do
      ...
      toSnapshotTreeM s.transformed.inner
