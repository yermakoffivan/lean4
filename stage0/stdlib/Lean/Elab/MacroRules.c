...
v___x_77_ = lean_mk_string_unchecked("while expanding", 15, 15);
return v___x_77_;
}
}
...
v___x_122_ = lean_mk_string_unchecked("with resulting expansion", 24, 24);
return v___x_122_;
}
}
