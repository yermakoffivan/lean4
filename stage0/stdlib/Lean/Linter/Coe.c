...
lean_ctor_set(v___x_448_, 2, v___y_418_);
lean_ctor_set(v___x_448_, 3, v___y_416_);
lean_ctor_set(v___x_448_, 4, v___x_447_);
lean_ctor_set_uint8(v___x_448_, sizeof(void*)*5, v___y_415_);
...
v___x_510_ = l_Lean_Syntax_getTailPos_x3f(v___y_507_, v___y_508_);
lean_dec(v___y_507_);
