...
lean_ctor_set_uint8(v___x_449_, sizeof(void*)*1, v___y_445_);
...
v___x_483_ = l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Parser_parseHeader_spec__2(v_inputCtx_420_, v___y_475_, v___x_481_, v_sz_482_, v___y_478_, v___y_477_);
...
v___x_508_ = l_Lean_Name_mkStr4(v___y_500_, v___y_496_, v___y_495_, v___x_507_);
...
_start:
{
uint8_t v___x_2274__boxed_687_; lean_object* v_res_688_; 
v___x_2274__boxed_687_ = lean_unbox(v___x_678_);
v_res_688_ = l___private_Init_While_0__whileM_erased___at___00Lean_Parser_parseCommand_spec__1___redArg___lam__0(v_snd_677_, v___x_2274__boxed_687_, v_inputCtx_679_, v_pos_680_, v_stxStack_681_, v_val_682_, v___x_683_, v_fst_684_, v_____r_685_, v_pos_686_);
lean_dec(v_fst_684_);
return v_res_688_;
}
}
