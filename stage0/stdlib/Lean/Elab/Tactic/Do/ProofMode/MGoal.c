...
_start:
{
uint8_t v___y_4450__boxed_778_; uint8_t v_suppressElabErrors_boxed_779_; uint8_t v_res_780_; lean_object* v_r_781_; 
v___y_4450__boxed_778_ = lean_unbox(v___y_775_);
v_suppressElabErrors_boxed_779_ = lean_unbox(v_suppressElabErrors_776_);
v_res_780_ = l_Lean_logAt___at___00Lean_log___at___00Lean_logWarning___at___00Lean_Elab_Tactic_Do_ProofMode_checkHasType_spec__0_spec__0_spec__1___lam__0(v___y_4450__boxed_778_, v_suppressElabErrors_boxed_779_, v_x_777_);
lean_dec(v_x_777_);
