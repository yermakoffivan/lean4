...
v___x_1658_ = lean_nat_add(v___y_1655_, v___y_1657_);
...
lean_ctor_set(v___x_1637_, 3, v___y_1656_);
...
lean_ctor_set(v_reuseFailAlloc_1663_, 3, v___y_1656_);
